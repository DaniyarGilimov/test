...
// ! Ваш реальный Email, на который будет отправлено письмо
$admin_mail = $mail;
...
// Тело письма <li><b>Email:</b> '.$userdata['user_mail'].'</li> <li><b>Адрес:</b> '.$userdata['user_address'].'</li> <li><b>Комментарий:</b> '.$userdata['user_comment'].'</li>
$body = '
<html>
<head>
  <title>'.$subject.'</title>
