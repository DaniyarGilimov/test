...
class Jcart {
	...
	*/
	public function display_cart() {
		...
		if ($isCheckout !== true) {
			if ($this->itemCount > 0) {
				echo "<a class='cart-label' href='checkout.php'>Корзина $this->itemCount</a>\n";
			}
		}
		...
		if ($isCheckout === true) {
			...
			echo tab(3) . "<input type='$inputType' $src id='jcart-paypal-checkout' name='jcartPaypalCheckout' value='Оплатить' $disablePaypalCheckout />\n";
		}
